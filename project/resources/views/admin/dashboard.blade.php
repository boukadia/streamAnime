                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addAnimeModal">
                            <i class="fas fa-plus me-1"></i> Ajouter un Anime
                        </button>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <form class="col-md-6" action="{{ Route('dashboard') }}" method="get">
                                <div class="row">
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-3">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('filtrageParCategoryAdmin', $category) }}">
                                                {{ $category->name }}
                                            </a>
                                        </li>
                                        @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('filtrageParEtatAdmin', ['status' => 'En cours']) }}">En cours</a></li>
                                        <li><a class="dropdown-item" href="{{ route('filtrageParEtatAdmin', ['status' => 'Complet']) }}">Terminé</a></li>
                                        <li><a class="dropdown-item" href="{{ route('filtrageParEtatAdmin', ['status' => 'Pas encore']) }}">À venir</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-striped" id="animeTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/build/assets/img/anime/{{ $anime->posterLink }}" alt="Anime Cover" class="img-thumbnail" style="width: 100px; height: auto;">
                                        </td>
                                        ...
                                        <td><span class="badge bg-success">{{ $anime->status }}</span></td>

                                        <td>
                                            <a href="{{ Route('editAnime',$anime) }}" class="btn btn-sm btn-primary "><i class="fas fa-edit"></i></a>
                                            <a href="{{ Route('deleteAnime',$anime) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
            ...
            <div class="modal-body">
                <form action="{{ route('addAnime') }}" method="post" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="animeTrailer" name="studio" >
                    </div>
