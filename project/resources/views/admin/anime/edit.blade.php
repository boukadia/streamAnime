...
<body>
  ...
  Ajouter un Anime
                ...
                <div class="modal-body" >
                    ...
                    <form action="{{ route('updateAnime', $anime) }}" method="POST" class="anime-form">
    @csrf
    <div class="card anime-form-card">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $anime->titre }}" class="form-control custom-input" id="titre" name="titre" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea class="form-control custom-input" id="description" name="description" rows="4">{{ $anime->description }}</textarea>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group image-upload-container">
                        <input type="url" class="form-control custom-input mt-2" id="image_url" value="{{ $anime->posterLink }}" name="posterLink" >
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="trailer">Trailer</label>
                            <input type="text" value="{{ $anime->trailer }}" class="form-control custom-input" id="trailer" name="trailer" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="studio">Studio</label>
                            <input type="text" value="{{ $anime->studio }}" class="form-control custom-input" id="studio" name="studio" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="thumbnail">Thumbnail</label>
                            <input type="text" value="{{ $anime->thumbnail }}" class="form-control custom-input" id="thumbnail" name="thumbnail" >
                        </div>
                        
                        <div class="form-group col-md-6">
                            <label for="rating">Rating</label>
                            <input type="text" value="{{ $anime->rating }}" class="form-control custom-input" id="rating" name="rating" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="score">Score</label>
                            <input type="text" value="{{ $anime->score }}" class="form-control custom-input" id="score" name="score" >
                        </div>

                        <div class="form-group col-md-6">
                            <label for="rank">Note <small>(sur 10)</small></label>
                            <input type="number" value="{{ $anime->rank }}" class="form-control custom-input" id="rank" name="rank" min="0" max="10" step="0.1">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control custom-select" id="status" name="status">
                                <option value="ongoing">{{ $anime->statut }}</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" value="{{ $anime->yearCreation }}" class="form-control custom-input" id="yearCreation" name="yearCreation">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="yearFin">Date de sortie</label>
                            <input type="date" value="{{ $anime->yearFin }}" class="form-control custom-input" id="yearFin" name="yearFin">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer text-center">
            <button type="submit" class="btn btn-primary submit-btn">Modifier l'anime</button>
